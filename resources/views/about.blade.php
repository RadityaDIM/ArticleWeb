                ...
                <div
                    ...
                    <div class="lg:pt-4 lg:pr-8">
                        <div class="lg:max-w-lg">
                            <h2 class="text-base/7 font-semibold text-blue-700 dark:text-indigo-400">Deploy faster</h2>
                            <p
                                class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-black dark:text-white sm:text-5xl">
                                A
                                better workflow</p>
                            <p class="mt-6 text-lg/8 text-black dark:text-gray-300">Lorem ipsum, dolor sit amet
