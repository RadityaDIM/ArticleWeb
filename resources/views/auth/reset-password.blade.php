                    ...
                    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                        ...
                        <div
                            ...
                            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <form class="space-y-4 md:space-y-6" action="{{ route('password.update') }}"
                                    method="POST">
                                    {{-- CSRF UNTUK MENGEMBALIKAN KE HALAMAN TERSEBUT --}}
                                    @csrf
                                    ...
                                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                        Don't have an account? <a href="{{ route('register.store') }}"
                                    ...
                                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                        Forgot password? <a href="{{ route('password.request') }}"
